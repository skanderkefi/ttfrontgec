...
@Component({
  selector: 'app-adminbordsottnd',
  templateUrl: './adminbordsottnd.component.html',
  styleUrls: ['./adminbordsottnd.component.css']
})
export class AdminbordsottndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM SOTETEL TND","id":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM SOTETEL TND" )
