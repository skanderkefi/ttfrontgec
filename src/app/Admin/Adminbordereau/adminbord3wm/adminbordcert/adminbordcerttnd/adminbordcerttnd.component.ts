...
@Component({
  selector: 'app-adminbordcerttnd',
  templateUrl: './adminbordcerttnd.component.html',
  styleUrls: ['./adminbordcerttnd.component.css']
})
export class AdminbordcerttndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM CERT TND","id":"",
  "nature":"3WM","natureRaff":"TND","reference":"BOF/3WM-CERT/","sentAt":"","sentBy":"",
