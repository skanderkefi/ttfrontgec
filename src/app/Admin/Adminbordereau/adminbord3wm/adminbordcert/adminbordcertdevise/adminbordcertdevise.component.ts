...
@Component({
  selector: 'app-adminbordcertdevise',
  templateUrl: './adminbordcertdevise.component.html',
  styleUrls: ['./adminbordcertdevise.component.css']
})
export class AdminbordcertdeviseComponent implements OnInit {
 
  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM CERT DEVISE","id":"",
  "nature":"3WM","natureRaff":"DEVISE","reference":"BOF/3WM-CERT-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM CERT DEVISE" )
