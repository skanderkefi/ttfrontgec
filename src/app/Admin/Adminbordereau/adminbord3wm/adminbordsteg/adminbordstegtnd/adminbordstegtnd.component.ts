...
@Component({
  selector: 'app-adminbordstegtnd',
  templateUrl: './adminbordstegtnd.component.html',
  styleUrls: ['./adminbordstegtnd.component.css']
})
export class AdminbordstegtndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM STEG TND","id":"",
  "nature":"3WM","natureRaff":"TND","reference":"BOF/3WM-STEG/","sentAt":"","sentBy":"",
