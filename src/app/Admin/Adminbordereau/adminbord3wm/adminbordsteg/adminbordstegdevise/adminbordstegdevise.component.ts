...
@Component({
  selector: 'app-adminbordstegdevise',
  templateUrl: './adminbordstegdevise.component.html',
  styleUrls: ['./adminbordstegdevise.component.css']
})
export class AdminbordstegdeviseComponent implements OnInit {
 
  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM STEG DEVISE","id":"",
  "nature":"3WM","natureRaff":"DEVISE","reference":"BOF/3WM-STEG-DEVISE/","sentAt":"","sentBy":"",
