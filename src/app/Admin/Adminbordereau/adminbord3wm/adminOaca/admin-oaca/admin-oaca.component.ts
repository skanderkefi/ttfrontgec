...
@Component({
  selector: 'app-admin-oaca',
  templateUrl: './admin-oaca.component.html',
  styleUrls: ['./admin-oaca.component.css']
})
export class AdminOacaComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM OACA TND","id":"",
  "nature":"3WM","natureRaff":"TND","reference":"BOF/3WM-OACA/","sentAt":"","sentBy":"",
