...
@Component({
  selector: 'app-adminbordoacadevise',
  templateUrl: './adminbordoacadevise.component.html',
  styleUrls: ['./adminbordoacadevise.component.css']
})
export class AdminbordoacadeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM OACA DEVISE","id":"",
  "nature":"3WM","natureRaff":"DEVISE","reference":"BOF/3WM-OACA-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM OACA DEVISE" )
