...
@Component({
  selector: 'app-adminborddouanetnd',
  templateUrl: './adminborddouanetnd.component.html',
  styleUrls: ['./adminborddouanetnd.component.css']
})
export class AdminborddouanetndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM DOUANE TND","id":"",
  "nature":"3WM","natureRaff":"TND","reference":"BOF/3WM-DOUANE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM DOUANE TND" )
