...
@Component({
  selector: 'app-adminbordristtnd',
  templateUrl: './adminbordristtnd.component.html',
  styleUrls: ['./adminbordristtnd.component.css']
})
export class AdminbordristtndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM RISTOURNE TND","id":"",
  "nature":"3WM","natureRaff":"TND","reference":"BOF/3WM-RISTOURNE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM RISTOURNE TND" )
