...
@Component({
  selector: 'app-adminbordchloctnd',
  templateUrl: './adminbordchloctnd.component.html',
  styleUrls: ['./adminbordchloctnd.component.css']
})
export class AdminbordchloctndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM CHARGE LOCATIVE TND","id":"",
  "nature":"3WM","natureRaff":"TND","reference":"BOF/3WM-CHARGE LOCATIVE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM CHARGE LOCATIVE TND" )
