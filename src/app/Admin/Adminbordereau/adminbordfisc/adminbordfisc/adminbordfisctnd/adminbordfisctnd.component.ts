...
@Component({
  selector: 'app-adminbordfisctnd',
  templateUrl: './adminbordfisctnd.component.html',
  styleUrls: ['./adminbordfisctnd.component.css']
})
export class AdminbordfisctndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALITÉ LOCALE TND","id":"",
  "nature":"FISCALITÉ","natureRaff":"TND","reference":"BOF/FISCALITÉ-LOCALE-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALITÉ LOCALE TND" )
