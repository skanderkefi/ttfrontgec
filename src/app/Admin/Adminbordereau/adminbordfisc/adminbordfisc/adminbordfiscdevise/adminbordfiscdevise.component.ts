...
@Component({
  selector: 'app-adminbordfiscdevise',
  templateUrl: './adminbordfiscdevise.component.html',
  styleUrls: ['./adminbordfiscdevise.component.css']
})
export class AdminbordfiscdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALITÉ LOCALE DEVISE","id":"",
  "nature":"FISCALITÉ LOCALE","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-LOCALE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALITÉ LOCALE DEVISE" )
