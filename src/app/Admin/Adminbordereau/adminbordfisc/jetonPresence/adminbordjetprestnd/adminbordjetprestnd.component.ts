...
@Component({
  selector: 'app-adminbordjetprestnd',
  templateUrl: './adminbordjetprestnd.component.html',
  styleUrls: ['./adminbordjetprestnd.component.css']
})
export class AdminbordjetprestndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALTÉ JETON DE PRÉSENCE TND","id":"",
  "nature":"FISCALTÉ","natureRaff":"DEVISE","reference":"BOF/FISCALTÉ-JETON DE PRÉSENCE-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALTÉ JETON DE PRÉSENCE TND" )
