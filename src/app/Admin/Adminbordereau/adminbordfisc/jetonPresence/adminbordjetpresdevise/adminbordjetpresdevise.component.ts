...
@Component({
  selector: 'app-adminbordjetpresdevise',
  templateUrl: './adminbordjetpresdevise.component.html',
  styleUrls: ['./adminbordjetpresdevise.component.css']
})
export class AdminbordjetpresdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALTÉ JETON DE PRÉSENCE DEVISE","id":"",
  "nature":"FISCALTÉ","natureRaff":"DEVISE","reference":"BOF/FISCALTÉ-JETON DE PRÉSENCE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALTÉ JETON DE PRÉSENCE DEVISE" )
