...
@Component({
  selector: 'app-adminbordchsoctnd',
  templateUrl: './adminbordchsoctnd.component.html',
  styleUrls: ['./adminbordchsoctnd.component.css']
})
export class AdminbordchsoctndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALITÉ CHARGE LOCALE-DEVISE","id":"",
  "nature":"FISCALITÉ","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-CHARGE LOCALE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALITÉ CHARGE LOCALE-DEVISE" )
