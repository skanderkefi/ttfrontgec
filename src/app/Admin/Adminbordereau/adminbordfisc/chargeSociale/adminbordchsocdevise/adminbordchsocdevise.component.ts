...
@Component({
  selector: 'app-adminbordchsocdevise',
  templateUrl: './adminbordchsocdevise.component.html',
  styleUrls: ['./adminbordchsocdevise.component.css']
})
export class AdminbordchsocdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALTÉ CHARGE SOCIALE DEVISE","id":"",
  "nature":"FISCALITÉ","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-SOCIALE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALTÉ SOCIALE DEVISE" )
