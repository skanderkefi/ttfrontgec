...
@Component({
  selector: 'app-adminbordpeatnd',
  templateUrl: './adminbordpeatnd.component.html',
  styleUrls: ['./adminbordpeatnd.component.css']
})
export class AdminbordpeatndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALITÉ PAIEMENT ET AUTRE - TND","id":"",
  "nature":"FISCALITÉ","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-PAIEMENT ET AUTRE-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALITÉ PAIEMENT ET AUTRE - TND" )
