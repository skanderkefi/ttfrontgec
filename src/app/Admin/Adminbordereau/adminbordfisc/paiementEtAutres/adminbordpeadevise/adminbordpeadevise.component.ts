...
@Component({
  selector: 'app-adminbordpeadevise',
  templateUrl: './adminbordpeadevise.component.html',
  styleUrls: ['./adminbordpeadevise.component.css']
})
export class AdminbordpeadeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCLATÉ PAIEMENT ET AUTRES - DEVISE","id":"",
  "nature":"FISCLATÉ","natureRaff":"DEVISE","reference":"BOF/FISCLATÉ-PAIEMENT ET AUTRES-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCLATÉ PAIEMENT ET AUTRES - DEVISE" )
