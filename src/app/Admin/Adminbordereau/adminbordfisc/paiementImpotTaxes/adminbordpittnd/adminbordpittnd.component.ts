...
@Component({
  selector: 'app-adminbordpittnd',
  templateUrl: './adminbordpittnd.component.html',
  styleUrls: ['./adminbordpittnd.component.css']
})
export class AdminbordpittndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALTÉ PAIEMENT IMPÔTS ET TAXES - TND","id":"",
  "nature":"FISCALTÉ","natureRaff":"DEVISE","reference":"BOF/FISCALTÉ-PAIEMENT IMPÔTS ET TAXES-TND/","sentAt":"","sentBy":"",
