...
@Component({
  selector: 'app-adminbordformintdevise',
  templateUrl: './adminbordformintdevise.component.html',
  styleUrls: ['./adminbordformintdevise.component.css']
})
export class AdminbordformintdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALTÉ FORMATEURS INTERNES DEVISE","id":"",
  "nature":"FISCALTÉ","natureRaff":"DEVISE","reference":"BOF/FISCALTÉ-FORMATEURS INTERNES-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALTÉ FORMATEURS INTERNES DEVISE" )
