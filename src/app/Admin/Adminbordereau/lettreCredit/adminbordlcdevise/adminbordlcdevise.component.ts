...
@Component({
  selector: 'app-adminbordlcdevise',
  templateUrl: './adminbordlcdevise.component.html',
  styleUrls: ['./adminbordlcdevise.component.css']
})
export class AdminbordlcdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"LETTRE CRÉDIT DEVISE","id":"",
  "nature":"LETTRE CRÉDIT","natureRaff":"DEVISE","reference":"BOF/LETTRE-CRÉDIT-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="LETTRE CRÉDIT DEVISE" )
