...
@Component({
  selector: 'app-adminbordlctnd',
  templateUrl: './adminbordlctnd.component.html',
  styleUrls: ['./adminbordlctnd.component.css']
})
export class AdminbordlctndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"LETTRE CRÉDIT TND","id":"",
  "nature":"LETTRE CRÉDIT","natureRaff":"DEVISE","reference":"BOF/LETTRE-CRÉDIT-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="LETTRE CRÉDIT TND" )
