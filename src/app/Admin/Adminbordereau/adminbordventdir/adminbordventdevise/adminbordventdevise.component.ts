...
@Component({
  selector: 'app-adminbordventdevise',
  templateUrl: './adminbordventdevise.component.html',
  styleUrls: ['./adminbordventdevise.component.css']
})
export class AdminbordventdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"VENTILATION DIRECTE DEVISE","id":"",
  "nature":"VENTILATION DIRECTE","natureRaff":"DEVISE","reference":"BOF/VENTILATION-DIRECTE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="VENTILATION DIRECTE DEVISE" )
