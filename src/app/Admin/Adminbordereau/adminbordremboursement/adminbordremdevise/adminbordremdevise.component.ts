...
@Component({
  selector: 'app-adminbordremdevise',
  templateUrl: './adminbordremdevise.component.html',
  styleUrls: ['./adminbordremdevise.component.css']
})
export class AdminbordremdeviseComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM REMBOURSEMENT DEVISE","id":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="REMBOURSEMENT DEVISE" )
