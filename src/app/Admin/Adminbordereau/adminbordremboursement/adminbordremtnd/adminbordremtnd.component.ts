...
@Component({
  selector: 'app-adminbordremtnd',
  templateUrl: './adminbordremtnd.component.html',
  styleUrls: ['./adminbordremtnd.component.css']
})
export class AdminbordremtndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM REMBOURSEMENT TND","id":"",
  "nature":"REMBOURSEMENT","natureRaff":"DEVISE","reference":"BOF/REMBOURSEMENT-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="REMBOURSEMENT-TND" )
