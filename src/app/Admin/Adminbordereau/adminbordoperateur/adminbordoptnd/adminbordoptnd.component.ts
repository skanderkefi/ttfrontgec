...
@Component({
  selector: 'app-adminbordoptnd',
  templateUrl: './adminbordoptnd.component.html',
  styleUrls: ['./adminbordoptnd.component.css']
})
export class AdminbordoptndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"OPERATEUR TND","id":"",
  "nature":"OPERATEUR","natureRaff":"DEVISE","reference":"BOF/OPERATEUR-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="OPERATEUR TND" )
