...
@Component({
  selector: 'app-adminbordopdevise',
  templateUrl: './adminbordopdevise.component.html',
  styleUrls: ['./adminbordopdevise.component.css']
})
export class AdminbordopdeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"OPERATEUR DEVISE","id":"",
  "nature":"OPERATEUR","natureRaff":"DEVISE","reference":"BOF/OPERATEUR-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="OPERATEUR DEVISE" )
