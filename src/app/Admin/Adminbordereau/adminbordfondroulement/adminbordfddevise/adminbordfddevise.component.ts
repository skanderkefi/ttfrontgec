...
@Component({
  selector: 'app-adminbordfddevise',
  templateUrl: './adminbordfddevise.component.html',
  styleUrls: ['./adminbordfddevise.component.css']
})
export class AdminbordfddeviseComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM FOND DE ROULEMENT DEVISE","id":"",
  "nature":"3WM","natureRaff":"DEVISE","reference":"BOF/3WM-FOND-ROULEMENT-DEVISE/","sentAt":"","sentBy":"",
