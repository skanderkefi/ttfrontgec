...
@Component({
  selector: 'app-adminbordfdtnd',
  templateUrl: './adminbordfdtnd.component.html',
  styleUrls: ['./adminbordfdtnd.component.css']
})
export class AdminbordfdtndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM FOND DE ROULEMENT TND","id":"",
  "nature":"FOND DE ROULEMENT","natureRaff":"DEVISE","reference":"BOF/3WM-FOND(ROULEMENT-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM FOND DE ROULEMENT TND" )
