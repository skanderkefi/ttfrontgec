...
@Component({
  selector: 'app-adminbordcmdtnd',
  templateUrl: './adminbordcmdtnd.component.html',
  styleUrls: ['./adminbordcmdtnd.component.css']
})
export class AdminbordcmdtndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"COMMISSION ET DISTRIBUTION TND","id":"",
  "nature":"COMMISSION ET DISTRIBUTION","natureRaff":"DEVISE","reference":"BOF/COMMISSION-DISTRIBUTION-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="COMMISSION ET DISTRIBUTION TND" )
