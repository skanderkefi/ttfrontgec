...
@Component({
  selector: 'app-adminbordfindevise',
  templateUrl: './adminbordfindevise.component.html',
  styleUrls: ['./adminbordfindevise.component.css']
})
export class AdminbordfindeviseComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FINANCEMENT DEVISE","id":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FINANCEMENT DEVISE" )
