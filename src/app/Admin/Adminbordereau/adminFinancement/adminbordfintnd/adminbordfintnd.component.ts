...
@Component({
  selector: 'app-adminbordfintnd',
  templateUrl: './adminbordfintnd.component.html',
  styleUrls: ['./adminbordfintnd.component.css']
})
export class AdminbordfintndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FINANCEMENT TND","id":"",
  "nature":"FINANCEMENT","natureRaff":"DEVISE","reference":"BOF/FINANCEMENT-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FINANCEMENT-TND" )
