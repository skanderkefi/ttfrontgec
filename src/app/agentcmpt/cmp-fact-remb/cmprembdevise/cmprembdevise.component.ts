...
@Component({
  selector: 'app-cmprembdevise',
  templateUrl: './cmprembdevise.component.html',
  styleUrls: ['./cmprembdevise.component.css']
})
export class CmprembdeviseComponent implements OnInit {
    ...
    factureValidateModal(facture){
      ...
      convertToPdf() {
        ...
        rejectFacture(){
          ...
          this.dataService.updateFactureFdRemp(this.factureToReject).subscribe((msg: any[])=>{
            console.log(msg);
          }) 
          // location.reload();
        }
        ...
        validateFacture(){
          ...
          this.dataService.updateFactureFdRemp(this.factureToValidate).subscribe((msg: any[])=>{
            console.log(msg);
          }) 
          // location.reload();
        }
