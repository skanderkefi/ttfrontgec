...
@Component({
  selector: 'app-bofacletrtnd',
  templateUrl: './bofacletrtnd.component.html',
  styleUrls: ['../../facture.css']
})
export class BofacletrtndComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  p:number=1;
  factureToCreate={"bordereau":"","created_by":"4125","dateFact":Date.now(),"id":"",
  "devise": "TND", "direction":"","dossier": "LETTRE CRÉDIT TND" ,"factname":"","fournisseur":"",
