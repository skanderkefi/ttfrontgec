...
@Component({
  selector: 'app-envristournetnd',
  templateUrl: './envristournetnd.component.html',
  styleUrls: ['./envristournetnd.component.css']
})
export class EnvristournetndComponent implements OnInit {
  ...
  "devise": "TND", "dossier": "RISTOURNE - TND" ,"factname":"","fournisseur":"",
  "montant":"","num_po":"","objet":"","status":"",
...
,"created_by":"4125","dateOp":"","datereception":"","updated_at":"","pieceJointe":"","idfiscale":""};
 ...
 "devise": "TND", "dossier": "RISTOURNE - TND" ,"factname":"","fournisseur":"","status":"",
  ...
  showFacture(){
    this.dataService.showFacture3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="RISTOURNE - TND" &&  data[i].status=="sent")
