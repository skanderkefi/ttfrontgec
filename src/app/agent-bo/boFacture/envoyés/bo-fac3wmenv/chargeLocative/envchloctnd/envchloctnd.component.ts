...
@Component({
  selector: 'app-envchloctnd',
  templateUrl: './envchloctnd.component.html',
  styleUrls: ['./envchloctnd.component.css']
})
export class EnvchloctndComponent implements OnInit {
...
,"created_by":"4125","dateOp":"","datereception":"","updated_at":"","pieceJointe":"","idfiscale":""};
 ...
 "devise": "TND", "dossier": "CHARGE LOCATIVE - TND" ,"factname":"","fournisseur":"","status":"",
  ...
  showFacture(){
    this.dataService.showFacture3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="CHARGE LOCATIVE - TND" &&  data[i].status=="sent")
