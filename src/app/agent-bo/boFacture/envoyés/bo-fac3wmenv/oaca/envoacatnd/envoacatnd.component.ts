...
@Component({
  selector: 'app-envoacatnd',
  templateUrl: './envoacatnd.component.html',
  styleUrls: ['./envoacatnd.component.css']
})
export class EnvoacatndComponent implements OnInit {
...
,"created_by":"4125","dateOp":"","datereception":"","updated_at":"","pieceJointe":"","idfiscale":""};
 ...
 "devise": "TND", "dossier": "OACA - TND" ,"factname":"","fournisseur":"","status":"",
  ...
  showFacture(){
    this.dataService.showFacture3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="OACA - TND" &&  data[i].status=="sent")
