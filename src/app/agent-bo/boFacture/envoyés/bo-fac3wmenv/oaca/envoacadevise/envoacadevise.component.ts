...
@Component({
  selector: 'app-envoacadevise',
  templateUrl: './envoacadevise.component.html',
  styleUrls: ['./envoacadevise.component.css']
})
export class EnvoacadeviseComponent implements OnInit {
  ...
  "devise": "", "dossier": "OACA - DEVISE" ,"factname":"","fournisseur":"",
  ...
  showFacture(){
    this.dataService.showFacture3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="OACA - DEVISE" && data[i].status=="sent")
