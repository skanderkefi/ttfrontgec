...
@Component({
  selector: 'app-rejdouanetnd',
  templateUrl: './rejdouanetnd.component.html',
  styleUrls: ['./rejdouanetnd.component.css']
})
export class RejdouanetndComponent implements OnInit {
   ...
   myTexts: IMultiSelectTexts = {
    ...
    "devise": "TND","direction":"","dossier": "DOUANE - TND" ,"factname":"","fournisseur":"",
    ...
    showFacture(){
      this.dataService.showFacture3wm().subscribe((data: any[])=>{
        ...
        for(let i=0; i<data.length; i++){
          if(data[i].dossier=="DOUANE - TND" && data[i].status=="rejected")
