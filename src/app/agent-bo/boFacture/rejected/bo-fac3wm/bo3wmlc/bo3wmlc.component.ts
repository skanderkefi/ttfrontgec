...
@Component({
  selector: 'app-bo3wmlc',
  templateUrl: './bo3wmlc.component.html',
  styleUrls: ['./bo3wmlc.component.css']
})
export class ventBo3wmlcComponent implements OnInit {
  ...
  "devise": "TND", "direction":"","dossier": "LETTRE DE CRÉDIT TND" ,"factname":"","fournisseur":"",
  "status":"en cours","montant":"","numFacture":"","num_po":"","objet":"",
  "pathname":"","periode_conso":"","structure":"","createdAt":Date.now(),"credit":"","destinataire":""
   ,"datereception":"","echeance":"","pathPdf":"","typeFin":"","updatedAt":"","idFiscale":"","pieceJointe":""};
