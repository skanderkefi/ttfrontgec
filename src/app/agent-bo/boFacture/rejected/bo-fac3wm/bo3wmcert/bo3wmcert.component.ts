...
@Component({
  selector: 'app-bo3wmcert',
  templateUrl: './bo3wmcert.component.html',
  styleUrls: ['./bo3wmcert.component.css']
})
export class rjctndBo3wmcertComponent implements OnInit {
 ...
 myTexts: IMultiSelectTexts = {
  ...
  "devise": "TND","direction":"","dossier": "3WM TND CERT" ,"factname":"","fournisseur":"",
  ...
  showFacture(){
    this.dataService.showFacture3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="3WM TND CERT" && data[i].status=="rejected")
