...
@Component({
  selector: 'app-rejjetprestnd',
  templateUrl: './rejjetprestnd.component.html',
  styleUrls: ['./rejjetprestnd.component.css']
})
export class RejjetprestndComponent implements OnInit {
  ...
  "devise": "TND", "dossier": "JETON DE PRÉSENCE TND" ,"factname":"","fournisseur":"",
  ...
  showFacture(){
    this.dataService.showFactureFisc().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="JETON DE PRÉSENCE TND" && data[i].status=="rejected")
