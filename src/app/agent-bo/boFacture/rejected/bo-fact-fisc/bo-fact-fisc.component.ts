...
@Component({
  selector: 'app-bo-fact-fisc',
  templateUrl: './bo-fact-fisc.component.html',
  styleUrls: ['./bo-fact-fisc.component.css']
})
export class BoFactFiscComponent implements OnInit {
