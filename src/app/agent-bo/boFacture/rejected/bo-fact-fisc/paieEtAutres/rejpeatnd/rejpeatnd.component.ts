...
@Component({
  selector: 'app-rejpeatnd',
  templateUrl: './rejpeatnd.component.html',
  styleUrls: ['./rejpeatnd.component.css']
})
export class RejpeatndComponent implements OnInit {
  ...
  "devise": "TND", "dossier": "PAIEMENT ET AUTRES - TND" ,"factname":"","fournisseur":"",
  ...
  showFacture(){
    this.dataService.showFactureFisc().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="PAIEMENT ET AUTRES - TND" && data[i].status=="rejected")
