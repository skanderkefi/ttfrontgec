...
@Component({
  selector: 'app-rejformindevise',
  templateUrl: './rejformindevise.component.html',
  styleUrls: ['./rejformindevise.component.css']
})
export class RejformindeviseComponent implements OnInit {
  ...
  "devise": "", "dossier": "FORMATEURS INTERNES DEVISE" ,"factname":"","fournisseur":"",
  ...
  showFacture(){
    this.dataService.showFactureFisc().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="FORMATEURS INTERNES DEVISE" && data[i].status=="rejected")
