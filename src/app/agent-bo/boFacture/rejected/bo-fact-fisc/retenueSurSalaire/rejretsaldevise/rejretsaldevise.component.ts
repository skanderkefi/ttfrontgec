...
@Component({
  selector: 'app-rejretsaldevise',
  templateUrl: './rejretsaldevise.component.html',
  styleUrls: ['./rejretsaldevise.component.css']
})
export class RejretsaldeviseComponent implements OnInit {
  ...
  "devise": "", "dossier": "RETENUE SUR SALAIRE - DEVISE" ,"factname":"","fournisseur":"",
  ...
  showFacture(){
    this.dataService.showFactureFisc().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="RETENUE SUR SALAIRE - DEVISE" && data[i].status=="rejected")
