...
@Component({
  selector: 'app-bo-fact-remb',
  templateUrl: './bo-fact-remb.component.html',
  styleUrls: ['./bo-fact-remb.component.css']
})
export class BoFactRembComponent implements OnInit {
