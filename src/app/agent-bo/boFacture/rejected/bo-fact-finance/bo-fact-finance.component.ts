...
@Component({
  selector: 'app-bo-fact-finance',
  templateUrl: './bo-fact-finance.component.html',
  styleUrls: ['./bo-fact-finance.component.css']
})
export class BoFactFinanceComponent implements OnInit {
 ...
 "devise": "TND", "direction":"","dossier": "FINANCEMENT DEVISE" ,"factname":"","fournisseur":"",
 "status":"","montant":"","num_fact":"","num_po":"","objet":"",
 "pathname":"","periode_conso":"","structure":"","createdAt":Date.now(),"credit":"","destinataire":""
  ,"datereception":"","echeance":"","pathPdf":"","typeFin":"","updatedAt":"","pieceJointe":"","idfiscale":""};
  ...
  showFacture(){
    this.dataService.showFactureFin().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].devise=="TND" && data[i].status=="rejected" )
