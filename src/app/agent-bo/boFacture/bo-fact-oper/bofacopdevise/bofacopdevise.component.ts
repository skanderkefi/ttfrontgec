...
@Component({
  selector: 'app-bofacopdevise',
  templateUrl: './bofacopdevise.component.html',
  styleUrls: ['../../facture.css']
})
export class BofacopdeviseComponent implements OnInit {
  ...
  "devise": "", "direction":"","dossier": "OPERATEUR DEVISE" ,"factname":"","fournisseur":"",
  "status":"en cours","montant":"","num_po":"","objet":"",
  "pathname":"","structure":"","createdAt":Date.now(),"datereception":"","updatedAt":"",
  "dateOp":"","pieceJointe":"","idfiscale":"","pathpdf":""};
