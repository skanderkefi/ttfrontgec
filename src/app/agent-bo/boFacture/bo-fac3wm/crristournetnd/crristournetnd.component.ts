...
@Component({
  selector: 'app-crristournetnd',
  templateUrl: './crristournetnd.component.html',
  styleUrls: ['./crristournetnd.component.css']
})
export class CrristournetndComponent implements OnInit {
  ...
  "devise": "TND","direction":"","dossier": "3WM RISTOURNE TND" ,"factname":"","fournisseur":"",
