...
@Component({
  selector: 'app-croacadevise',
  templateUrl: './croacadevise.component.html',
  styleUrls: ['./croacadevise.component.css']
})
export class CroacadeviseComponent implements OnInit {
