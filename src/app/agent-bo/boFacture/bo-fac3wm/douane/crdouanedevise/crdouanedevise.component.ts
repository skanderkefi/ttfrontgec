...
@Component({
  selector: 'app-crdouanedevise',
  templateUrl: './crdouanedevise.component.html',
  styleUrls: ['./crdouanedevise.component.css']
})
export class CrdouanedeviseComponent implements OnInit {
