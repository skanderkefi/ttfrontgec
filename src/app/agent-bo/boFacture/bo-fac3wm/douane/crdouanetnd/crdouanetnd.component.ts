...
@Component({
  selector: 'app-crdouanetnd',
  templateUrl: './crdouanetnd.component.html',
  styleUrls: ['./crdouanetnd.component.css']
})
export class CrdouanetndComponent implements OnInit {
  ...
  "devise": "TND","direction":"","dossier": "3WM DOUANE TND" ,"factname":"","fournisseur":"",
