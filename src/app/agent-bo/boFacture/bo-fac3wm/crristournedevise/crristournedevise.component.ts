...
@Component({
  selector: 'app-crristournedevise',
  templateUrl: './crristournedevise.component.html',
  styleUrls: ['./crristournedevise.component.css']
})
export class CrristournedeviseComponent implements OnInit {
  ...
  "devise": "DEVISE","direction":"","dossier": "3WM RISTOURNE DEVISE" ,"factname":"","fournisseur":"",
