...
//   "devise": "TND","direction":"","dossier": "3WM TND SOTETEL" ,"factname":"","fournisseur":"",
...
console.log("all fact = "+this.Factures3wmTnd);

  for(let i=0; i<this.Factures3wmTnd.length; i++){
    if(this.Factures3wmTnd[i].num_po==this.po){
  ...
  if (this.gettedFacture.dateRefusParAp!="" && this.gettedFacture.dateRefusParAp!=null){
    this.refusAp=true;
  }
  if (this.gettedFacture.datValidationParAp!="" && this.gettedFacture.datValidationParAp!=null){
    this.validationAp=true;
  }
  if (this.gettedFacture.dateRefusParTreso!="" && this.gettedFacture.dateRefusParTreso!=null){
    this.refustreso=true;
  }
  if (this.gettedFacture.theTresoValidationDate!="" && this.gettedFacture.theTresoValidationDate!=null){
    this.validationtreso=true;
  }
  this.factureWfDetails=this.gettedFacture;
}
