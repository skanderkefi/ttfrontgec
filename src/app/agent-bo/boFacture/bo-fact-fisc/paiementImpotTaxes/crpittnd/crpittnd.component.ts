...
@Component({
  selector: 'app-crpittnd',
  templateUrl: './crpittnd.component.html',
  styleUrls: ['./crpittnd.component.css']
})
export class CrpittndComponent implements OnInit {
  ...
  "devise": "TND", "dossier": "PAIEMENT IMPOTS ET TAXES - TND" ,"factname":"","fournisseur":"",
...
,"created_by":"4125","dateOp":"","datereception":"","updated_at":"","pieceJointe":"","idfiscale":""};
 ...
 "devise": "TND", "dossier": "FISCALITÉ TND" ,"factname":"","fournisseur":"",
 "montant":"","num_po":"","objet":"",
 "pathPdf":"","beneficiaire":"","created_at":""
,"created_by":"4125","dateOp":"","datereception":"","updated_at":"","pieceJointe":"","idfiscale":""};
  ...
  showFacture(){
    this.dataService.showFactureFisc().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].dossier=="PAIEMENT IMPOTS ET TAXES - TND" )
