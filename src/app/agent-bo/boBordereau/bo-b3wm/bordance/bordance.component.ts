...
@Component({
  selector: 'app-bordance',
  templateUrl: './bordance.component.html',
  styleUrls: ['../../facture.css']
})
export class BordanceComponent implements OnInit {
  ...
  "nature":"ANCE","natureRaff":"TND","reference":"BOF/ANCE-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="ANCE" && data[i].natureRaff=="TND"){
