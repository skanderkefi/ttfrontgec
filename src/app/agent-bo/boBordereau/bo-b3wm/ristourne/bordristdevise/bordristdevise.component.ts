...
@Component({
  selector: 'app-bordristdevise',
  templateUrl: './bordristdevise.component.html',
  styleUrls: ['./bordristdevise.component.css']
})
export class BordristdeviseComponent implements OnInit {
  ...
  "nature":"RISTOURNE","natureRaff":"DEVISE","reference":"BOF/RISTOURNE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="RISTOURNE" && data[i].natureRaff=="DEVISE"){
