...
@Component({
  selector: 'app-borddouanedevise',
  templateUrl: './borddouanedevise.component.html',
  styleUrls: ['./borddouanedevise.component.css']
})
export class BorddouanedeviseComponent implements OnInit {
  ...
  "nature":"DOUANE","natureRaff":"DEVISE","reference":"BOF/DOUANE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="DOUANE" && data[i].natureRaff=="DEVISE"){
