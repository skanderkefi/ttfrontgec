...
@Component({
  selector: 'app-bordcert',
  templateUrl: './bordcert.component.html',
  styleUrls: ['../../facture.css']
})
export class BordcertComponent implements OnInit {
  ...
  "nature":"CERT","natureRaff":"TND","reference":"BOF/CERT-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="CERT" && data[i].natureRaff=="TND"){
