...
@Component({
  selector: 'app-bordoacatnd',
  templateUrl: './bordoacatnd.component.html',
  styleUrls: ['./bordoacatnd.component.css']
})
export class BordoacatndComponent implements OnInit {
  ...
  "nature":"OACA","natureRaff":"TND","reference":"BOF/OACA-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="OACA" && data[i].natureRaff=="TND"){
