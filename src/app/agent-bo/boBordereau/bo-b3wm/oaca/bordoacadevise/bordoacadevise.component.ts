...
@Component({
  selector: 'app-bordoacadevise',
  templateUrl: './bordoacadevise.component.html',
  styleUrls: ['./bordoacadevise.component.css']
})
export class BordoacadeviseComponent implements OnInit {
  ...
  "nature":"OACA","natureRaff":"DEVISE","reference":"BOF/OACA-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="OACA" && data[i].natureRaff=="DEVISE"){
