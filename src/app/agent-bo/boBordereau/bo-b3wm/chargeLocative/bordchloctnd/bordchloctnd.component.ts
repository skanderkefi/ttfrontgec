...
@Component({
  selector: 'app-bordchloctnd',
  templateUrl: './bordchloctnd.component.html',
  styleUrls: ['./bordchloctnd.component.css']
})
export class BordchloctndComponent implements OnInit {
  ...
  "nature":"CHARGE LOCATIVE","natureRaff":"TND","reference":"BOF/CHARGE LOCATIVE-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="CHARGE LOCATIVE" && data[i].natureRaff=="TND"){
