...
@Component({
  selector: 'app-bordchlocdevise',
  templateUrl: './bordchlocdevise.component.html',
  styleUrls: ['./bordchlocdevise.component.css']
})
export class BordchlocdeviseComponent implements OnInit {
  ...
  "nature":"CHARGE LOCATIVE","natureRaff":"DEVISE","reference":"BOF/CHARGE LOCATIVE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="CHARGE LOCATIVE" && data[i].natureRaff=="DEVISE"){
