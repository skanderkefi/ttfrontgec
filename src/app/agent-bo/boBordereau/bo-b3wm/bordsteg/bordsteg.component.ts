...
@Component({
  selector: 'app-bordsteg',
  templateUrl: './bordsteg.component.html',
  styleUrls: ['../../facture.css']
})
export class BordstegComponent implements OnInit {
  ...
  "nature":"STEG","natureRaff":"TND","reference":"BOF/STEG-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="STEG" && data[i].natureRaff=="TND"){
