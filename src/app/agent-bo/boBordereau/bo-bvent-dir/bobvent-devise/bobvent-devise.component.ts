...
@Component({
  selector: 'app-bobvent-devise',
  templateUrl: './bobvent-devise.component.html',
  styleUrls: ['./bobvent-devise.component.css']
})
export class BobventDeviseComponent implements OnInit {
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="VENTILATION DIRECTE" && data[i].natureRaff=="DEVISE"){
