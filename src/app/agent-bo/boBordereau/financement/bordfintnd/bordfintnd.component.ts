...
@Component({
  selector: 'app-bordfintnd',
  templateUrl: './bordfintnd.component.html',
  styleUrls: ['./bordfintnd.component.css']
})
export class BordfintndComponent implements OnInit {
  ...
  "nature":"FINANCEMENT","natureRaff":"TND","reference":"BOF/FINANCEMENT-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="FINANCEMENT" && data[i].natureRaff=="TND"){
