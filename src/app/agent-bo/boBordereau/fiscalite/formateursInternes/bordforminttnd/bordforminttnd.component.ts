...
@Component({
  selector: 'app-bordforminttnd',
  templateUrl: './bordforminttnd.component.html',
  styleUrls: ['./bordforminttnd.component.css']
})
export class BordforminttndComponent implements OnInit {
  ...
  "nature":"FORMATEURS INTERNE","natureRaff":"TND","reference":"BOF/FORMATEURS INTERNE-TND/","sentAt":"","sentBy":"",
  "status":"","updatedAt":Date.now(),"toAp":""};
  bordereauToUpdate={"createdAt":Date.now(),"createdBy":"4125","folder":"","id":"",
  "nature":"FORMATEURS INTERNE","natureRaff":"DEVISE","reference":"BOF/FORMATEURS INTERNE-TND/","sentAt":"","sentBy":"",
  "status":"","updatedAt":Date.now(),"toAp":""};
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="FORMATEURS INTERNE" && data[i].natureRaff=="TND"){
    ...
    showFacture(){
      this.dataService.showFactureFisc().subscribe((data: any[])=>{
        ...
        for(let i=0; i<data.length; i++){
          ...
          if(data[i].dossier=="FORMATEURS INTERNES TND"){
