...
@Component({
  selector: 'app-bordchsoctnd',
  templateUrl: './bordchsoctnd.component.html',
  styleUrls: ['./bordchsoctnd.component.css']
})
export class BordchsoctndComponent implements OnInit {
  ...
  "nature":"CHARGE SOCIALE","natureRaff":"TND","reference":"BOF/CHARGE SOCIALE-TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="CHARGE SOCIALE" && data[i].natureRaff=="TND"){
