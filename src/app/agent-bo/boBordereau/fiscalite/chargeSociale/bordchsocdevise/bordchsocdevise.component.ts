...
@Component({
  selector: 'app-bordchsocdevise',
  templateUrl: './bordchsocdevise.component.html',
  styleUrls: ['./bordchsocdevise.component.css']
})
export class BordchsocdeviseComponent implements OnInit {
  ...
  "nature":"CHARGE SOCIALE","natureRaff":"DEVISE","reference":"BOF/CHARGE SOCIALE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        ...
        if(data[i].nature=="CHARGE SOCIALE" && data[i].natureRaff=="DEVISE"){
