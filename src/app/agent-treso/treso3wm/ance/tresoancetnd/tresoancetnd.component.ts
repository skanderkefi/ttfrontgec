...
@Component({
  selector: 'app-tresoancetnd',
  templateUrl: './tresoancetnd.component.html',
  styleUrls: ['./tresoancetnd.component.css']
})
export class TresoancetndComponent implements OnInit {
