...
@Component({
  selector: 'app-tresooacatnd',
  templateUrl: './tresooacatnd.component.html',
  styleUrls: ['./tresooacatnd.component.css']
})
export class TresooacatndComponent implements OnInit {
