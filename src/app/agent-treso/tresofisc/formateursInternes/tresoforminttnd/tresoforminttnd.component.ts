...
@Component({
  selector: 'app-tresoforminttnd',
  templateUrl: './tresoforminttnd.component.html',
  styleUrls: ['./tresoforminttnd.component.css']
})
export class TresoforminttndComponent implements OnInit {
