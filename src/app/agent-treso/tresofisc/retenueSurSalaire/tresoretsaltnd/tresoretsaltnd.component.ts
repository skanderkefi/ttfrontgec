...
@Component({
  selector: 'app-tresoretsaltnd',
  templateUrl: './tresoretsaltnd.component.html',
  styleUrls: ['./tresoretsaltnd.component.css']
})
export class TresoretsaltndComponent implements OnInit {
